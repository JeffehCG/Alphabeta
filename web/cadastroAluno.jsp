...
<%  String erro = null;
    ...
    try {
        if (request.getParameter("gravar") != null) {
            ...
            Date dtNasc = new Date(formato.parse(date).getTime());
            
            Professor prof = Professor.PesquisarProfessorCpf(cpf);
            if(prof == null){
            Aluno.inserirAluno(nome, sobrenome, cpf, rua, bairro, numero, cidade, estado, cep, telefone, nmresp, cfpresp, senha, dtNasc,email);
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="src/style/cadastro-aluno.css">      
    ...
    <body style="
        ...
        <div class="main ui white inverted stacked segment text container main-content">
                        ...
                        <div class="inline fields">
                            <div class="sixteen wide field">
                                <select class="ui dropdown" name="dia">
                                    ...
                                    <option value="31">31</option>                                    </div>
                            </select>
                        </div>
                        <div class="sixteen wide field">
                            <select class="ui dropdown" name="mes">
                                <option class="default text" style="display: none">Mês</option>
        ...
        <div class="fields">
            ...
            <div class="three wide field">
                <label>Estado</label>
                <input type="text" name="estado" maxlength="50"/><br>
            </div>
            <div class="five wide field">
                <label>CEP</label>
        ...
        <div class="fields">
            <div class="six wide field">
                ...
                <input type="tel" name="telefone" maxlength="11"/><br>
            </div>
            <div class="twelve wide field">
                <label>Email</label>
        ...
        <div class="fields">
            <div class="twelve wide field">
                ...
                <input type="text" name="nmresp" maxlength="50"/><br>
            </div>
            <div class="six wide field">
                <label>CPF do responsável</label>
                <input type="text" name="cpfresp" maxlength="11"/><br>
            </div>
        </div>
        ...
        <div class="fields">
            ...
            <div class="eight wide field">
                ...
                <input type="password" name="rsenha"/><br>
            </div>
        </div>
        <div class="ui bottom fields">
            <div class="eight wide field">
                <button class="ui fluid large blue submit button" type="submit" name="gravar" value="Cadastrar">Criar Novo Usuário</button>
            </div>
            <div class="eight wide field">
                <a href="login.jsp"><button class="ui fluid large red submit button" type="button" name="cancelar" value="Cancelar">Cancelar Cadastro</button></a>
            </div>
        </div>
    </form>
</div>
