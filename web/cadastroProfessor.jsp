...
<%  String erro = null;
    ...
    try {
        if (request.getParameter("gravar") != null) {
            ...
            Aluno alun = Aluno.PesquisarAlunoCpf(cpf);
            if(alun == null){
            Professor.inserirProfessor(nome, sobrenome, cpf, dtNasc, rua, bairro, numero, cidade, estado, cep, telefone, email, senha);
...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="src/style/cadastro-professor.css">      
